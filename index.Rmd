...
Al concluir el curso, los participantes podrán realizar la evaluación de Reservas Marinas con MAREA. Aunque el curso está diseñado para realizar la evaluación con MAREA, se presentarán las bases teóricas y ejemplos prácticos para comprender a fondo la evaluación. A lo largo del curso, usaremos trabajos publicados en revistas arbitradas como ejemplos de buenas y malas prácticas. Todas las presentaciones, datos y artículos utilizados en este curso están disponibles en el [repositorio del curso](https://github.com/jcvdav/CursoMAREA), y en los enlaces disponibles en cada sección.

Las preguntas y discusiones son bienvenidas a lo largo de todo el curso, siemrpe y cuando el tiempo lo permita.

# Temario

A continuación se presenta el temario del curso, incluyendo los tiempos estimados para las secciones/actividades planeadas. El curso será una combinación de teoría y práctica. La dinámica general será presentar los conceptos y acompañarlos de ejercicios que permitan entenderlos mejor. Para esto, se espera que los asistentes cuenten con acceso a una computadora con Excel, o papel, lápiz y calculadora. Realizaremos operaciones básicas (suma, resta, multiplicación y división).

## Introducción

### Áreas Marinas Protegidas y Reservas Marinas (30 - 45 min)
...
- Literatura recomendada:
    ...
    - Beneficios de las AMP [@aburtooropeza_2011-ya; @lester_2009-Ks]
    - Beneficios de RM sobre AMP [@lester_2008-F_; @micheli_2012-EU; @munguavega_2015-yg]


### Historia de la evaluación de RM (30 - 45 min)
    
La evaluación de RM no es algo nuevo. Sin embargo, muy pocos trabajos las han evaluado utilizando técnicas que distingan entre correlación y causalidad. Por lo tanto, será útil hacer una recapitulación de indicadores y metodologías comúnmente usadas antes de presentar la metodología utilizada por MAREA. Se presentarán casos publicados en literatura científica como ejemploenfocándonos en los indicadores y diseños de muestreo. Revisaremos tres diseños de muestro generales que se han utilizado en la evaluación de RM y otros impactos ecológicos. Por medio de ejercicios prácticos, identificaremos las ventajas y desventajas de cada uno, así como sus implicaciones en el manejo. Una discusión grupal motivará la necesidad de alinear objetivos de manejo con indicadores y el uso apropiado de análisis que permitan informar el manjo de las reservas.

**Recursos**

- [Diapositivas]()
- Literatura recomendada:
    - Otras formas de evaluar RM [@pomeroy_2005-Py; @pomeroy_2004-23; @mascia_2017-m_]
    - Importancia de incorporar dimensiones socioeconómicas y de gobernanza [@basurto_2013-oq; @basurto_2012-Mz]
    - Evaluación Antes-Después [@betti_2017-lq]
    - Evaluación Control-Impacto / Dentro-Fuera [@guidetti_2014-8Z; @friedlander_2017-oI; @lester_2009-Ks; @aburtooropeza_2011-ya; @rodriguez_2017-PD]
...
### Objetivos e indicadores (30 - 45 min)
    
Habiendo repasado las metodologías comúnmente utilizadas en ecología, daremos un paso atrás para pensar en el manejo. Hablaremos de la identificación de objetivos para los cuales las reservas son establecidas y de los indicadores que pueden utilizarse para medir su impacto. Se presentarán los indicadores en las tres principales categorías *Biofísicos* *Socioeconómicos* y de *Gobernanza* y daremos un espacio para el diálogo y discusión sobre otros indicadores.

**Recursos**

- [Diapositivas]()
- Literatura recomendada:
    - Revisiones sistemáticas de indicadores [@lester_2009-Ks; @woodcock_2017-Wm].

### Datos y formato de datos (30 - 45 min)
...
- [Diapositivas]()
- [Carpeta de dropbox]() con los datos
...
Comenzaremos por describir los resultados que produce MAREA: la tabla de puntuación y el reporte técnico. Primero discutiremos sobre el desempeño de la reserva utilizando únicamente la tabla de puntuación. Después, descargaremos el reporte técnico que produc MAREA para llegar a conclusiones definitivas sobre el desempeño de la reserva.
